...
class DemographicSurveyGUI():
    ...
    questions_and_answers = [('Gender:', ['Male', 'Female', 'Non-binary', 'Prefer not to say']),
                             ...
                             ('Please rate your ability playing the video game Overcooked:', ['Very low skill level', 'Low skill level', 'Moderate skill level', 'High skill level', 'Very high skill level'])]
